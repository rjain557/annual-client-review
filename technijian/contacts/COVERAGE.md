...
**Generated:** 2026-04-29T10:02:47  
**Source:** `tech-legal/clients/<CODE>/CONTACTS.md` (read-only)

## Resolution policy

Recipients are **only** the emails parsed from the portal-designated `Primary Contact`, `Invoice Recipient`, or `Contract Signer` sections of each client's `CONTACTS.md`. The C1/C2/C3 roles in the user list are portal user types, **not** authority to sign contracts/proposals/estimates - they are NOT used as a fallback. If no designation is set in the portal, the client appears in `needs_designation_set.csv` with suggested signer candidates rather than getting auto-CC'd to the whole directory.
...
- **Operational send list (2026-04)**: managed-IT-active AND send-ready = **5** clients (see `send_list_2026-04.csv`)
- Active but not send-ready (need portal designation): **25** (see `needs_designation_set.csv`)
...
|---|---|---:|---|---|---|---:|
| AAVA | Aventine at Aliso Viejo Apartments | 6989 | cp,huntress,crowdstrike | **no** | — | 2 |
| ACU | Acuity Advisors | 7139 | cp,huntress,crowdstrike | **no** | — | 23 |
| AFFG | American Fundstars Financial Group LLC | 8141 | cp,huntress,crowdstrike | **no** | — | 2 |
| ALE | Alera Group | 7988 | **none** | **no** | — | 2 |
| ALG | Algro International | 7923 | cp,huntress,crowdstrike | **no** | — | 7 |
| ANI | Andersen Industries, Inc. | 13 | cp,huntress,crowdstrike | yes | yes | 2 |
| AOC | Apartment Association of Orange County | 6270 | cp,huntress,crowdstrike | **no** | — | 18 |
...
| BST | Boston Group | 6247 | cp,crowdstrike | **no** | — | 66 |
| BWH | Brandywine Homes | 6245 | cp,huntress,crowdstrike | **no** | — | 13 |
| CAM | Coast Aero Mfg | 4307 | **none** | yes | yes | 3 |
| CBI | Christian Brothers Interiors | 7826 | cp,huntress,crowdstrike | **no** | — | 3 |
| CBL | Chris Bank Law | 5664 | cp,huntress,crowdstrike | **no** | — | 1 |
| CCC | Culp Construction Company | 5914 | cp,huntress,crowdstrike | **no** | — | 35 |
| COB | Core Benefits | 41 | **none** | yes | yes | 4 |
| CSS | Custom Silicon Solutions | 7093 | _cp-only_ | **no** | — | 2 |
| DTS | Disruptix Talent Solutions | 8052 | cp,huntress,crowdstrike | **no** | — | 2 |
| EAG | Ellis Advisory Group | 6236 | **none** | **no** | — | 1 |
| EBRMD | Ernest B Robinson, MD, PC | 8027 | cp,huntress,crowdstrike | **no** | — | 1 |
| FAL | Law Offices of Stephen Abraham | 5483 | **none** | **no** | — | 1 |
| FOR | Falconer of Redlands | 8066 | _cp-only_ | **no** | — | 2 |
| GRF | Golden Rain Foundation - LWSB | 2709 | **none** | yes | yes | 6 |
| GSD | GSD Solutions | 7849 | **none** | **no** | — | 1 |
| HHOC | Housing for Health OC | 7280 | cp,huntress,crowdstrike | **no** | — | 4 |
| HIT | Hula IT Services | 7873 | **none** | **no** | — | 1 |
| ICML | ICM Lending | 70 | **none** | yes | yes | 4 |
...
| KCC | Kiva Container Corp | 3221 | **none** | yes | yes | 4 |
| KES | KES Homes | 7930 | cp,huntress,crowdstrike | **no** | — | 1 |
| KRLMD | Kenneth Lynn MD | 86 | **none** | yes | yes | 2 |
...
| MGN | Magnespec | 93 | **none** | yes | yes | 11 |
...
| PCM | 180 Medical, Inc. | 114 | **none** | yes | yes | 23 |
| PMF | Premed Financial, Inc | 8019 | **none** | **no** | — | 2 |
| RALF | Richard C. Alter Law Firm | 4261 | _cp-only_ | yes | yes | 1 |
...
| SGC | Siege Consulting | 7946 | cp,huntress,crowdstrike | **no** | — | 1 |
| SSCI | SSCI, Inc. | 8011 | **none** | **no** | — | 2 |
| STW | STW Autosports | 8123 | **none** | **no** | — | 1 |
| SVE | Saddleback Valley Endodontic | 7296 | **none** | **no** | — | 1 |
| TALY | Talley & Associates | 7728 | cp,huntress,crowdstrike | **no** | — | 1 |
...
| VG | Vintage Group | 5839 | cp,huntress,crowdstrike | **no** | — | 3 |
| WCS | West Coast Shipping | 154 | **none** | yes | yes | 3 |
